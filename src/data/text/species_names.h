const u8 gSpeciesNames[NUM_SPECIES][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_MEOWSCARADA] = _("Meoscarada"),
    ...
    [SPECIES_SQUAWKABILLY] = _("Squwkabily"),
    ...
    [SPECIES_DUDUNSPARCE] = _("Dudunsprce"),
    ...
    [SPECIES_MOSSLO] = _("Mosslo"),
    [SPECIES_THERIMOSS] = _("Therimoss"),
    [SPECIES_MOSSIVE] = _("Mossive"),
    [SPECIES_GRIFLINT] = _("Griflint"),
    [SPECIES_GRIFLARE] = _("Griflare"),
    [SPECIES_GRYPHERNO] = _("Grypherno"),
    [SPECIES_WOOFIN] = _("Woofin"),
    [SPECIES_HOUNTIDE] = _("Hountide"),
    [SPECIES_SHARBARIC] = _("Sharbaric"),
    [SPECIES_BASSERINTH] = _("Basserinth"),
    [SPECIES_GAZEAR] = _("Gazear"),
#endif
    ...
    [SPECIES_DIALGA_PRIMAL] = _("Dialga"),
    [SPECIES_PALKIA_PRIMAL] = _("Palkia"),
...
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_MIME_JR_GALARIAN] = _("Mime Jr."),
#endif 
...
//Hisuian Forms
...
#endif
    [SPECIES_CYNDAQUIL_HISUIAN] = _("Cyndaquil"),
    [SPECIES_QUILAVA_HISUIAN] = _("Quilava"),
#if P_GEN_5_POKEMON == TRUE
    [SPECIES_OSHAWOTT_HISUIAN] = _("Oshawott"),
    [SPECIES_DEWOTT_HISUIAN] = _("Dewott"),
    [SPECIES_PETILIL_HISUIAN] = _("Petilil"),
    [SPECIES_RUFFLET_HISUIAN] = _("Rufflet"),
#endif
#if P_GEN_6_POKEMON == TRUE
    [SPECIES_BERGMITE_HISUIAN] = _("Bergmite"),
#endif
#if P_GEN_7_POKEMON == TRUE
    [SPECIES_ROWLET_HISUIAN] = _("Rowlet"),
    [SPECIES_DARTRIX_HISUIAN] = _("Dartrix"),
#endif

    //Paldean Forms
    [SPECIES_TAUROS_PALDEAN_COMBAT] = _("Tauros"),
    [SPECIES_TAUROS_PALDEAN_BLAZE] = _("Tauros"),
    [SPECIES_TAUROS_PALDEAN_AQUA] = _("Tauros"),
    ...
    [SPECIES_SHELLOS_SOUTH_SEA] = _("Shellos"),
    [SPECIES_SHELLOS_NORTH_SEA] = _("Shellos"),
    // Gastrodon
    [SPECIES_GASTRODON_EAST_SEA] = _("Gastrodon"),
    [SPECIES_GASTRODON_SOUTH_SEA] = _("Gastrodon"),
    [SPECIES_GASTRODON_NORTH_SEA] = _("Gastrodon"),
    // Rotom
    ...
    [SPECIES_ROTOM_DEX_1] = _("Rotom"),
    [SPECIES_ROTOM_DEX_2] = _("Rotom"),
    [SPECIES_ROTOM_DEX_3] = _("Rotom"),
    [SPECIES_ROTOM_DEX_4] = _("Rotom"),
    [SPECIES_ROTOM_DRON] = _("Rotom"),
    // Origin Forme
    ...
    [SPECIES_BASCULIN_YELLOW_STRIPED] = _("Basculin"),
    // Darmanitan
    ...
    // Solgaleo
    [SPECIES_SOLGALEO_BURST] = _("Solgaleo"),
    // Lunala
    [SPECIES_LUNALA_BURST] = _("Lunala"),
    // Necrozma
    ...
    [SPECIES_MAUSHOLD_FAMILY] = _("Maushold"),
    [SPECIES_SQUAWKABILLY_BLUE] = _("Squwkabily"),
    [SPECIES_SQUAWKABILLY_YELLOW] = _("Squwkabily"),
    [SPECIES_SQUAWKABILLY_WHITE] = _("Squwkabily"),
    [SPECIES_PALAFIN_HERO] = _("Palafin"),
    [SPECIES_TATSUGIRI_DROOPY] = _("Tatsugiri"),
    [SPECIES_TATSUGIRI_STRETCHY] = _("Tatsugiri"),
    [SPECIES_DUDUNSPARCE_THREE] = _("Dudunsprce"),
    [SPECIES_GIMMIGHOUL_ROAMING] = _("Gimmighoul"),
    [SPECIES_POLTCHAGEIST_MASTERPIECE] = _("Poltchgest"),
    [SPECIES_SINISTCHA_MASTERPIECE] = _("Sinistcha"),
    [SPECIES_OGERPON_WELLSPRING] = _("Ogerpon"),
    [SPECIES_OGERPON_HEATHFLAME] = _("Ogerpon"),
    [SPECIES_OGERPON_CORNERSTONE] = _("Ogerpon"),
    [SPECIES_TERAPAGOS_TERASTAL] = _("Terapagos"),
#endif
    [SPECIES_BULBASAUR_CLONE] = _("Bulbasaur"),
    [SPECIES_IVYSAUR_CLONE] = _("Ivysaur"),
    [SPECIES_VENUSAUR_CLONE] = _("Venusaur"),
    [SPECIES_CHARMANDER_CLONE] = _("Charmander"),
    [SPECIES_CHARMELEON_CLONE] = _("Charmeleon"),
    [SPECIES_CHARIZARD_CLONE] = _("Charizard"),
    [SPECIES_SQUIRTLE_CLONE] = _("Squirtle"),
    [SPECIES_WARTORTLE_CLONE] = _("Wartortle"),
    [SPECIES_BLASTOISE_CLONE] = _("Blastoise"),
    [SPECIES_ONIX_CRYSTAL] = _("Onix"),
    [SPECIES_STEELIX_CRYSTAL] = _("Steelix"),
    [SPECIES_STEELIX_MEGA_CRYSTAL] = _("Steelix"),
    [SPECIES_CATERPIE_PINK] = _("Caterpie"),
    [SPECIES_METAPOD_PINK] = _("Metapod"),
    [SPECIES_BUTTERFREE_PINK] = _("Butterfree"),
    [SPECIES_LUGIA_DARK] = _("Lugia"),
    [SPECIES_HO_OH_DARK] = _("Ho-Oh"),
};