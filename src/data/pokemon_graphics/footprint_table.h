const u8 *const gMonFootprintTable[NUM_SPECIES + 1] =
{
    ...
    [SPECIES_IRON_CROWN] = gMonFootprint_IronCrown,
    [SPECIES_TERAPAGOS] = gMonFootprint_Terapagos,
#endif
#if P_GEN_10_POKEMON == TRUE
    [SPECIES_MOSSLO] = gMonFootprint_Mosslo,
    [SPECIES_THERIMOSS] = gMonFootprint_Therimoss,
    [SPECIES_MOSSIVE] = gMonFootprint_Mossive,
    [SPECIES_GRIFLINT] = gMonFootprint_Griflint,
    [SPECIES_GRIFLARE] = gMonFootprint_Griflare,
    [SPECIES_GRYPHERNO] = gMonFootprint_Grypherno,
    [SPECIES_WOOFIN] = gMonFootprint_Woofin,
    [SPECIES_HOUNTIDE] = gMonFootprint_Hountide,
    [SPECIES_SHARBARIC] = gMonFootprint_Sharbaric,
    [SPECIES_BASSERINTH] = gMonFootprint_Basserinth,
    [SPECIES_GAZEAR] = gMonFootprint_Gazear,
#endif
