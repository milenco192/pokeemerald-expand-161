const struct CompressedSpriteSheet gMonFrontPicTable[NUM_SPECIES + 1] =
{
	...
	SPECIES_SPRITE(BRAMBLEGHAST, gMonFrontPic_Brambleghast),
	...
	SPECIES_SPRITE(SCREAM_TAIL, gMonFrontPic_ScreamTail),
	SPECIES_SPRITE(BRUTE_BONNET, gMonFrontPic_BruteBonnet),
	SPECIES_SPRITE(FLUTTER_MANE, gMonFrontPic_FlutterMane),
	SPECIES_SPRITE(SLITHER_WING, gMonFrontPic_SlitherWing),
	SPECIES_SPRITE(SANDY_SHOCKS, gMonFrontPic_SandyShocks),
	SPECIES_SPRITE(IRON_TREADS, gMonFrontPic_IronTreads),
	SPECIES_SPRITE(IRON_BUNDLE, gMonFrontPic_IronBundle),
	SPECIES_SPRITE(IRON_HANDS, gMonFrontPic_IronHands),
	SPECIES_SPRITE(IRON_JUGULIS, gMonFrontPic_IronJugulis),
	SPECIES_SPRITE(IRON_MOTH, gMonFrontPic_IronMoth),
	SPECIES_SPRITE(IRON_THORNS, gMonFrontPic_IronThorns),
	...
	SPECIES_SPRITE(POLTCHAGEIST, gMonFrontPic_Poltchageist),
	...
	SPECIES_SPRITE(FEZANDIPITI, gMonFrontPic_Fezandipiti),
    ...
    SPECIES_SPRITE(MOSSLO, gMonFrontPic_Mosslo),
    SPECIES_SPRITE(THERIMOSS, gMonFrontPic_Therimoss),
    SPECIES_SPRITE(MOSSIVE, gMonFrontPic_Mossive),
    SPECIES_SPRITE(GRIFLINT, gMonFrontPic_Griflint),
    SPECIES_SPRITE(GRIFLARE, gMonFrontPic_Griflare),
    SPECIES_SPRITE(GRYPHERNO, gMonFrontPic_Grypherno),
    SPECIES_SPRITE(WOOFIN, gMonFrontPic_Woofin),
    SPECIES_SPRITE(HOUNTIDE, gMonFrontPic_Hountide),
    SPECIES_SPRITE(SHARBARIC, gMonFrontPic_Sharbaric),
    SPECIES_SPRITE(BASSERINTH, gMonFrontPic_Basserinth),
    SPECIES_SPRITE(GAZEAR, gMonFrontPic_Gazear),
#endif
...
#if P_GEN_4_POKEMON == TRUE
    SPECIES_SPRITE(DIALGA_PRIMAL, gMonFrontPic_DialgaPrimal),
    SPECIES_SPRITE(PALKIA_PRIMAL, gMonFrontPic_PalkiaPrimal),
#endif
    ...
    SPECIES_SPRITE(PIKACHU_ALOLAN, gMonFrontPic_PikachuAlolan),
    SPECIES_SPRITE(EXEGGCUTE_ALOLAN, gMonFrontPic_ExeggcuteAlolan),
    SPECIES_SPRITE(CUBONE_ALOLAN, gMonFrontPic_CuboneAlolan),
...
#endif
    SPECIES_SPRITE(KOFFING_GALARIAN, gMonFrontPic_KoffingGalarian),
#if P_GEN_4_POKEMON == TRUE
    SPECIES_SPRITE(MIME_JR_GALARIAN, gMonFrontPic_MimeJrGalarian),
#endif
...
#endif
    SPECIES_SPRITE(CYNDAQUIL_HISUIAN, gMonFrontPic_CyndaquilHisuian),
    SPECIES_SPRITE(QUILAVA_HISUIAN, gMonFrontPic_QuilavaHisuian),
#if P_GEN_5_POKEMON == TRUE
    SPECIES_SPRITE(OSHAWOTT_HISUIAN, gMonFrontPic_OshawottHisuian),
    SPECIES_SPRITE(DEWOTT_HISUIAN, gMonFrontPic_DewottHisuian),
    SPECIES_SPRITE(PETILIL_HISUIAN, gMonFrontPic_PetililHisuian),
    SPECIES_SPRITE(RUFFLET_HISUIAN, gMonFrontPic_RuffletHisuian),
#endif
#if P_GEN_6_POKEMON == TRUE
    SPECIES_SPRITE(BERGMITE_HISUIAN, gMonFrontPic_BergmiteHisuian),
#endif
#if P_GEN_7_POKEMON == TRUE
    SPECIES_SPRITE(ROWLET_HISUIAN, gMonFrontPic_RowletHisuian),
    SPECIES_SPRITE(DARTRIX_HISUIAN, gMonFrontPic_DartrixHisuian),
#endif

    SPECIES_SPRITE(TAUROS_PALDEAN_COMBAT, gMonFrontPic_TaurosCombatPaldean),
	SPECIES_SPRITE(TAUROS_PALDEAN_BLAZE, gMonFrontPic_TaurosBlazePaldean),
	SPECIES_SPRITE(TAUROS_PALDEAN_AQUA, gMonFrontPic_TaurosAquaPaldean),
    ...
    SPECIES_SPRITE(SHELLOS_SOUTH_SEA, gMonFrontPic_ShellosSouthSea),
    SPECIES_SPRITE(SHELLOS_NORTH_SEA, gMonFrontPic_ShellosNorthSea),

    SPECIES_SPRITE(GASTRODON_EAST_SEA, gMonFrontPic_GastrodonEastSea),
    SPECIES_SPRITE(GASTRODON_SOUTH_SEA, gMonFrontPic_GastrodonSouthSea),
    SPECIES_SPRITE(GASTRODON_NORTH_SEA, gMonFrontPic_GastrodonNorthSea),
    ...
    SPECIES_SPRITE(ROTOM_DEX_1, gMonFrontPic_RotomDex1),
    SPECIES_SPRITE(ROTOM_DEX_2, gMonFrontPic_RotomDex2),
    SPECIES_SPRITE(ROTOM_DEX_3, gMonFrontPic_RotomDex3),
    SPECIES_SPRITE(ROTOM_DEX_4, gMonFrontPic_RotomDex4),
    SPECIES_SPRITE(ROTOM_DRON, gMonFrontPic_RotomDron),
    ...
    SPECIES_SPRITE(BASCULIN_YELLOW_STRIPED, gMonFrontPic_BasculinYellowStriped),
    ...
    SPECIES_SPRITE(SOLGALEO_BURST, gMonFrontPic_SolgaleoBurst),

    SPECIES_SPRITE(LUNALA_BURST, gMonFrontPic_LunalaBurst),
    ...
    SPECIES_SPRITE(URSALUNA_BLOODMOON, gMonFrontPic_UrsalunaBloodmoon),

    SPECIES_SPRITE(BASCULEGION_FEMALE, gMonFrontPic_BasculegionFemale),
#endif
 #if P_GEN_9_POKEMON == TRUE
	SPECIES_SPRITE(OINKOLOGNE_FEMALE, gMonFrontPic_OinkologneFemale),
	SPECIES_SPRITE(MAUSHOLD_FAMILY, gMonFrontPic_MausholdFamily),
	...
	SPECIES_SPRITE(DUDUNSPARCE_THREE, gMonFrontPic_DudunsparceThree),
	SPECIES_SPRITE(GIMMIGHOUL_ROAMING, gMonFrontPic_GimmighoulRoaming),
	SPECIES_SPRITE(POLTCHAGEIST_MASTERPIECE, gMonFrontPic_PoltchageistMasterpiece),
	SPECIES_SPRITE(SINISTCHA_MASTERPIECE, gMonFrontPic_SinistchaMasterpiece),
	SPECIES_SPRITE(OGERPON_WELLSPRING, gMonFrontPic_OgerponWellspring),
	SPECIES_SPRITE(OGERPON_HEATHFLAME, gMonFrontPic_OgerponHeathflame),
...
#endif
    SPECIES_SPRITE(BULBASAUR_CLONE, gMonFrontPic_BulbasaurClone),
    SPECIES_SPRITE(IVYSAUR_CLONE, gMonFrontPic_IvysaurClone),
    SPECIES_SPRITE(VENUSAUR_CLONE, gMonFrontPic_VenusaurClone),
    SPECIES_SPRITE(CHARMANDER_CLONE, gMonFrontPic_CharmanderClone),
    SPECIES_SPRITE(CHARMELEON_CLONE, gMonFrontPic_CharmeleonClone),
    SPECIES_SPRITE(CHARIZARD_CLONE, gMonFrontPic_CharizardClone),
    SPECIES_SPRITE(SQUIRTLE_CLONE, gMonFrontPic_SquirtleClone),
    SPECIES_SPRITE(WARTORTLE_CLONE, gMonFrontPic_WartortleClone),
    SPECIES_SPRITE(BLASTOISE_CLONE, gMonFrontPic_BlastoiseClone),

    SPECIES_SPRITE(ONIX_CRYSTAL, gMonFrontPic_OnixCrystal),
    SPECIES_SPRITE(STEELIX_CRYSTAL, gMonFrontPic_SteelixCrystal),
    SPECIES_SPRITE(STEELIX_MEGA_CRYSTAL, gMonFrontPic_SteelixMegaCrystal),

    SPECIES_SPRITE(CATERPIE_PINK, gMonFrontPic_CaterpiePink),
    SPECIES_SPRITE(METAPOD_PINK, gMonFrontPic_MetapodPink),
    SPECIES_SPRITE(BUTTERFREE_PINK, gMonFrontPic_ButterfreePink),

    SPECIES_SPRITE(LUGIA_DARK, gMonFrontPic_LugiaDark),
    SPECIES_SPRITE(HO_OH_DARK, gMonFrontPic_HoOhDark),
...
const struct CompressedSpriteSheet gMonFrontPicTableFemale[NUM_SPECIES + 1] =
{
    ...
    SPECIES_SPRITE(MEGANIUM, gMonFrontPic_MeganiumF),
    SPECIES_SPRITE(LEDYBA, gMonFrontPic_LedybaF),
    SPECIES_SPRITE(LEDIAN, gMonFrontPic_LedianF),
    SPECIES_SPRITE(XATU, gMonFrontPic_XatuF),
    SPECIES_SPRITE(SUDOWOODO, gMonFrontPic_SudowoodoF),
    SPECIES_SPRITE(POLITOED, gMonFrontPic_PolitoedF),
    SPECIES_SPRITE(AIPOM, gMonFrontPic_AipomF),
    SPECIES_SPRITE(WOOPER, gMonFrontPic_WooperF),
    SPECIES_SPRITE(QUAGSIRE, gMonFrontPic_QuagsireF),
    SPECIES_SPRITE(MURKROW, gMonFrontPic_MurkrowF),
    SPECIES_SPRITE(WOBBUFFET, gMonFrontPic_WobbuffetF),
    SPECIES_SPRITE(GIRAFARIG, gMonFrontPic_GirafarigF),
    SPECIES_SPRITE(GLIGAR, gMonFrontPic_GligarF),
    SPECIES_SPRITE(STEELIX, gMonFrontPic_SteelixF),
