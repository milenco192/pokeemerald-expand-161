const struct CompressedSpritePalette gMonShinyPaletteTable[NUM_SPECIES + 1] =
{
    ...
    SPECIES_SHINY_PAL(QUAXLY, gMonShinyPalette_Quaxly),
    SPECIES_SHINY_PAL(QUAXWELL, gMonShinyPalette_Quaxwell),
    SPECIES_SHINY_PAL(QUAQUAVAL, gMonShinyPalette_Quaquaval),
    SPECIES_SHINY_PAL(LECHONK, gMonShinyPalette_Lechonk),
    SPECIES_SHINY_PAL(OINKOLOGNE, gMonShinyPalette_Oinkologne), 
    SPECIES_SHINY_PAL(TAROUNTULA, gMonShinyPalette_Tarountula),
    SPECIES_SHINY_PAL(SPIDOPS, gMonShinyPalette_Spidops),
    SPECIES_SHINY_PAL(NYMBLE, gMonShinyPalette_Nymble),
    SPECIES_SHINY_PAL(LOKIX, gMonShinyPalette_Lokix),
    SPECIES_SHINY_PAL(PAWMI, gMonShinyPalette_Pawmi),
    SPECIES_SHINY_PAL(PAWMO, gMonShinyPalette_Pawmo),
    SPECIES_SHINY_PAL(PAWMOT, gMonShinyPalette_Pawmot),
    SPECIES_SHINY_PAL(TANDEMAUS, gMonShinyPalette_Tandemaus),
    SPECIES_SHINY_PAL(MAUSHOLD, gMonShinyPalette_Maushold),
    SPECIES_SHINY_PAL(FIDOUGH, gMonShinyPalette_Fidough),
    SPECIES_SHINY_PAL(DACHSBUN, gMonShinyPalette_Dachsbun),
    SPECIES_SHINY_PAL(SMOLIV, gMonShinyPalette_Smoliv),
    SPECIES_SHINY_PAL(DOLLIV, gMonShinyPalette_Dolliv),
    SPECIES_SHINY_PAL(ARBOLIVA, gMonShinyPalette_Arboliva),
    ...
    SPECIES_SHINY_PAL(ARMAROUGE, gMonShinyPalette_Armarouge),
    SPECIES_SHINY_PAL(CERULEDGE, gMonShinyPalette_Ceruledge),
    SPECIES_SHINY_PAL(TADBULB, gMonShinyPalette_Tadbulb),
    SPECIES_SHINY_PAL(BELLIBOLT, gMonShinyPalette_Bellibolt),
    SPECIES_SHINY_PAL(WATTREL, gMonShinyPalette_Wattrel),
    SPECIES_SHINY_PAL(KILOWATTREL, gMonShinyPalette_Kilowattrel),
    SPECIES_SHINY_PAL(MASCHIFF, gMonShinyPalette_Maschiff),
    SPECIES_SHINY_PAL(MABOSSTIFF, gMonShinyPalette_Mabosstiff),
    SPECIES_SHINY_PAL(SHROODLE, gMonShinyPalette_Shroodle),
    SPECIES_SHINY_PAL(GRAFAIAI, gMonShinyPalette_Grafaiai),
    SPECIES_SHINY_PAL(BRAMBLIN, gMonShinyPalette_Bramblin),
    SPECIES_SHINY_PAL(BRAMBLEGHAST, gMonShinyPalette_Brambleghast),
    SPECIES_SHINY_PAL(TOEDSCOOL, gMonShinyPalette_Toedscool),
    SPECIES_SHINY_PAL(TOEDSCRUEL, gMonShinyPalette_Toedscruel),
    SPECIES_SHINY_PAL(KLAWF, gMonShinyPalette_Klawf),
    SPECIES_SHINY_PAL(CAPSAKID, gMonShinyPalette_Capsakid),
    SPECIES_SHINY_PAL(SCOVILLAIN, gMonShinyPalette_Scovillain),
    SPECIES_SHINY_PAL(RELLOR, gMonShinyPalette_Rellor),
    SPECIES_SHINY_PAL(RABSCA, gMonShinyPalette_Rabsca),
    SPECIES_SHINY_PAL(FLITTLE, gMonShinyPalette_Flittle),
    SPECIES_SHINY_PAL(ESPATHRA, gMonShinyPalette_Espathra),
    SPECIES_SHINY_PAL(TINKATINK, gMonShinyPalette_Tinkatink),
    SPECIES_SHINY_PAL(TINKATUFF, gMonShinyPalette_Tinkatuff),
    SPECIES_SHINY_PAL(TINKATON, gMonShinyPalette_Tinkaton),
    SPECIES_SHINY_PAL(WIGLETT, gMonShinyPalette_Wiglett),
    SPECIES_SHINY_PAL(WUGTRIO, gMonShinyPalette_Wugtrio),
    SPECIES_SHINY_PAL(BOMBIRDIER, gMonShinyPalette_Bombirdier),
    SPECIES_SHINY_PAL(FINIZEN, gMonShinyPalette_Finizen),
    SPECIES_SHINY_PAL(PALAFIN, gMonShinyPalette_Palafin),
    SPECIES_SHINY_PAL(VAROOM, gMonShinyPalette_Varoom),
    SPECIES_SHINY_PAL(REVAVROOM, gMonShinyPalette_Revavroom),
    SPECIES_SHINY_PAL(CYCLIZAR, gMonShinyPalette_Cyclizar),
    SPECIES_SHINY_PAL(ORTHWORM, gMonShinyPalette_Orthworm),
    SPECIES_SHINY_PAL(GLIMMET, gMonShinyPalette_Glimmet),
    SPECIES_SHINY_PAL(GLIMMORA, gMonShinyPalette_Glimmora),
    SPECIES_SHINY_PAL(GREAVARD, gMonShinyPalette_Greavard),
    SPECIES_SHINY_PAL(HOUNDSTONE, gMonShinyPalette_Houndstone),
    SPECIES_SHINY_PAL(FLAMIGO, gMonShinyPalette_Flamigo),
    SPECIES_SHINY_PAL(CETODDLE, gMonShinyPalette_Cetoddle),
    SPECIES_SHINY_PAL(CETITAN, gMonShinyPalette_Cetitan),
    ...
    SPECIES_SHINY_PAL(CLODSIRE, gMonShinyPalette_Clodsire),
    SPECIES_SHINY_PAL(FARIGIRAF, gMonShinyPalette_Farigiraf),
    SPECIES_SHINY_PAL(DUDUNSPARCE, gMonShinyPalette_Dudunsparce),
    SPECIES_SHINY_PAL(KINGAMBIT, gMonShinyPalette_Kingambit),
    SPECIES_SHINY_PAL(GREAT_TUSK, gMonShinyPalette_GreatTusk),
    SPECIES_SHINY_PAL(SCREAM_TAIL, gMonShinyPalette_ScreamTail),
    SPECIES_SHINY_PAL(BRUTE_BONNET, gMonShinyPalette_BruteBonnet),
    SPECIES_SHINY_PAL(FLUTTER_MANE, gMonShinyPalette_FlutterMane),
    SPECIES_SHINY_PAL(SLITHER_WING, gMonShinyPalette_SlitherWing),
    SPECIES_SHINY_PAL(SANDY_SHOCKS, gMonShinyPalette_SandyShocks),
    SPECIES_SHINY_PAL(IRON_TREADS, gMonShinyPalette_IronTreads),
    SPECIES_SHINY_PAL(IRON_BUNDLE, gMonShinyPalette_IronBundle),
    SPECIES_SHINY_PAL(IRON_HANDS, gMonShinyPalette_IronHands),
    SPECIES_SHINY_PAL(IRON_JUGULIS, gMonShinyPalette_IronJugulis),
    SPECIES_SHINY_PAL(IRON_MOTH, gMonShinyPalette_IronMoth),
    SPECIES_SHINY_PAL(IRON_THORNS, gMonShinyPalette_IronThorns),
    ...
    SPECIES_SHINY_PAL(KORAIDON, gMonShinyPalette_Koraidon),
    SPECIES_SHINY_PAL(MIRAIDON, gMonShinyPalette_Miraidon),
    SPECIES_SHINY_PAL(WALKING_WAKE, gMonShinyPalette_WalkingWake),
    SPECIES_SHINY_PAL(IRON_LEAVES, gMonShinyPalette_IronLeaves),
    SPECIES_SHINY_PAL(DIPPLIN, gMonShinyPalette_Dipplin),
    SPECIES_SHINY_PAL(POLTCHAGEIST, gMonShinyPalette_Poltchageist),
    SPECIES_SHINY_PAL(SINISTCHA, gMonShinyPalette_Sinistcha),
    SPECIES_SHINY_PAL(OKIDOGI, gMonShinyPalette_Okidogi),
    SPECIES_SHINY_PAL(MUNKIDORI, gMonShinyPalette_Munkidori),
    SPECIES_SHINY_PAL(FEZANDIPITI, gMonShinyPalette_Fezandipiti),
    ...
    SPECIES_SHINY_PAL(MOSSLO, gMonShinyPalette_Mosslo),
    SPECIES_SHINY_PAL(THERIMOSS, gMonShinyPalette_Therimoss),
    SPECIES_SHINY_PAL(MOSSIVE, gMonShinyPalette_Mossive),
    SPECIES_SHINY_PAL(GRIFLINT, gMonShinyPalette_Griflint),
    SPECIES_SHINY_PAL(GRIFLARE, gMonShinyPalette_Griflare),
    SPECIES_SHINY_PAL(GRYPHERNO, gMonShinyPalette_Grypherno),
    SPECIES_SHINY_PAL(WOOFIN, gMonShinyPalette_Woofin),
    SPECIES_SHINY_PAL(HOUNTIDE, gMonShinyPalette_Hountide),
    SPECIES_SHINY_PAL(SHARBARIC, gMonShinyPalette_Sharbaric),
    SPECIES_SHINY_PAL(BASSERINTH, gMonShinyPalette_Basserinth),
    SPECIES_SHINY_PAL(GAZEAR, gMonShinyPalette_Gazear),
#endif
...
#if P_GEN_4_POKEMON == TRUE
    SPECIES_SHINY_PAL(DIALGA_PRIMAL, gMonShinyPalette_DialgaPrimal),
    SPECIES_SHINY_PAL(PALKIA_PRIMAL, gMonShinyPalette_PalkiaPrimal),
#endif
    ...
    SPECIES_SHINY_PAL(PIKACHU_ALOLAN, gMonShinyPalette_PikachuAlolan),
    SPECIES_SHINY_PAL(EXEGGCUTE_ALOLAN, gMonShinyPalette_ExeggcuteAlolan),
    SPECIES_SHINY_PAL(CUBONE_ALOLAN, gMonShinyPalette_CuboneAlolan),
...
#endif
    SPECIES_SHINY_PAL(KOFFING_GALARIAN, gMonShinyPalette_KoffingGalarian),
#if P_GEN_4_POKEMON == TRUE
    SPECIES_SHINY_PAL(MIME_JR_GALARIAN, gMonShinyPalette_MimeJrGalarian),
#endif
...
#endif
    SPECIES_SHINY_PAL(CYNDAQUIL_HISUIAN, gMonShinyPalette_CyndaquilHisuian),
    SPECIES_SHINY_PAL(QUILAVA_HISUIAN, gMonShinyPalette_QuilavaHisuian),
#if P_GEN_5_POKEMON == TRUE
    SPECIES_SHINY_PAL(OSHAWOTT_HISUIAN, gMonShinyPalette_OshawottHisuian),
    SPECIES_SHINY_PAL(DEWOTT_HISUIAN, gMonShinyPalette_DewottHisuian),
    SPECIES_SHINY_PAL(PETILIL_HISUIAN, gMonShinyPalette_PetililHisuian),
    SPECIES_SHINY_PAL(RUFFLET_HISUIAN, gMonShinyPalette_RuffletHisuian),
#endif
#if P_GEN_6_POKEMON == TRUE
    SPECIES_PAL(BERGMITE_HISUIAN, gMonShinyPalette_BergmiteHisuian),
#endif
#if P_GEN_7_POKEMON == TRUE
    SPECIES_SHINY_PAL(ROWLET_HISUIAN, gMonShinyPalette_RowletHisuian),
    SPECIES_SHINY_PAL(DARTRIX_HISUIAN, gMonShinyPalette_DartrixHisuian),
#endif

    SPECIES_SHINY_PAL(TAUROS_PALDEAN_COMBAT, gMonShinyPalette_TaurosCombatPaldean),
    SPECIES_SHINY_PAL(TAUROS_PALDEAN_BLAZE, gMonShinyPalette_TaurosBlazePaldean),
    SPECIES_SHINY_PAL(TAUROS_PALDEAN_AQUA, gMonShinyPalette_TaurosAquaPaldean),
    SPECIES_SHINY_PAL(WOOPER_PALDEAN, gMonShinyPalette_WooperPaldean),
    ...
    SPECIES_SHINY_PAL(SHELLOS_SOUTH_SEA, gMonShinyPalette_ShellosSouthSea),
    SPECIES_SHINY_PAL(SHELLOS_NORTH_SEA, gMonShinyPalette_ShellosNorthSea),

    SPECIES_SHINY_PAL(GASTRODON_EAST_SEA, gMonShinyPalette_GastrodonEastSea),
    SPECIES_SHINY_PAL(GASTRODON_SOUTH_SEA, gMonShinyPalette_GastrodonSouthSea),
    SPECIES_SHINY_PAL(GASTRODON_NORTH_SEA, gMonShinyPalette_GastrodonNorthSea),
    ...
    SPECIES_SHINY_PAL(ROTOM_DEX_1, gMonShinyPalette_RotomDex1),
    SPECIES_SHINY_PAL(ROTOM_DEX_2, gMonShinyPalette_RotomDex2),
    SPECIES_SHINY_PAL(ROTOM_DEX_3, gMonShinyPalette_RotomDex3),
    SPECIES_SHINY_PAL(ROTOM_DEX_4, gMonShinyPalette_RotomDex4),
    SPECIES_SHINY_PAL(ROTOM_DRON, gMonShinyPalette_RotomDron),
    ...
    SPECIES_SHINY_PAL(BASCULIN_YELLOW_STRIPED, gMonShinyPalette_BasculinYellowStriped),
    ...
    SPECIES_SHINY_PAL(SOLGALEO_BURST, gMonShinyPalette_SolgaleoBurst),

    SPECIES_SHINY_PAL(LUNALA_BURST, gMonShinyPalette_LunalaBurst),
    ...
    SPECIES_SHINY_PAL(URSALUNA_BLOODMOON, gMonShinyPalette_UrsalunaBloodmoon),
    SPECIES_SHINY_PAL(ENAMORUS_THERIAN, gMonShinyPalette_EnamorusTherian),
#endif
#if P_GEN_9_POKEMON == TRUE
    SPECIES_SHINY_PAL(OINKOLOGNE_FEMALE, gMonShinyPalette_OinkologneFemale),
    SPECIES_SHINY_PAL(MAUSHOLD_FAMILY, gMonShinyPalette_MausholdFamily),
    ...
    SPECIES_SHINY_PAL(DUDUNSPARCE_THREE, gMonShinyPalette_DudunsparceThree),
    SPECIES_SHINY_PAL(GIMMIGHOUL_ROAMING, gMonShinyPalette_GimmighoulRoaming),
    SPECIES_SHINY_PAL(POLTCHAGEIST_MASTERPIECE, gMonShinyPalette_PoltchageistMasterpiece),
    SPECIES_SHINY_PAL(SINISTCHA_MASTERPIECE, gMonShinyPalette_SinistchaMasterpiece),
    SPECIES_SHINY_PAL(OGERPON_WELLSPRING, gMonShinyPalette_OgerponWellspring),
    SPECIES_SHINY_PAL(OGERPON_HEATHFLAME, gMonShinyPalette_OgerponHeathflame),
...
#endif
    SPECIES_SHINY_PAL(BULBASAUR_CLONE, gMonShinyPalette_BulbasaurClone),
    SPECIES_SHINY_PAL(IVYSAUR_CLONE, gMonShinyPalette_IvysaurClone),
    SPECIES_SHINY_PAL(VENUSAUR_CLONE, gMonShinyPalette_VenusaurClone),
    SPECIES_SHINY_PAL(CHARMANDER_CLONE, gMonShinyPalette_CharmanderClone),
    SPECIES_SHINY_PAL(CHARMELEON_CLONE, gMonShinyPalette_CharmeleonClone),
    SPECIES_SHINY_PAL(CHARIZARD_CLONE, gMonShinyPalette_CharizardClone),
    SPECIES_SHINY_PAL(SQUIRTLE_CLONE, gMonShinyPalette_SquirtleClone),
    SPECIES_SHINY_PAL(WARTORTLE_CLONE, gMonShinyPalette_WartortleClone),
    SPECIES_SHINY_PAL(BLASTOISE_CLONE, gMonShinyPalette_BlastoiseClone),

    SPECIES_SHINY_PAL(ONIX_CRYSTAL, gMonShinyPalette_OnixCrystal),
    SPECIES_SHINY_PAL(STEELIX_CRYSTAL, gMonShinyPalette_SteelixCrystal),
    SPECIES_SHINY_PAL(STEELIX_MEGA_CRYSTAL, gMonShinyPalette_SteelixMegaCrystal),

    SPECIES_SHINY_PAL(CATERPIE_PINK, gMonShinyPalette_CaterpiePink),
    SPECIES_SHINY_PAL(METAPOD_PINK, gMonShinyPalette_MetapodPink),
    SPECIES_SHINY_PAL(BUTTERFREE_PINK, gMonShinyPalette_ButterfreePink),

    SPECIES_SHINY_PAL(LUGIA_DARK, gMonShinyPalette_LugiaDark),
    SPECIES_SHINY_PAL(HO_OH_DARK, gMonShinyPalette_HoOhDark),
