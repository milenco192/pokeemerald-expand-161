const struct CompressedSpritePalette gMonPaletteTable[NUM_SPECIES + 1] =
{
	...
	SPECIES_PAL(BRAMBLEGHAST, gMonPalette_Brambleghast),
	...
	SPECIES_PAL(SLITHER_WING, gMonPalette_SlitherWing),
	SPECIES_PAL(SANDY_SHOCKS, gMonPalette_SandyShocks),
	SPECIES_PAL(IRON_TREADS, gMonPalette_IronTreads),
	SPECIES_PAL(IRON_BUNDLE, gMonPalette_IronBundle),
	SPECIES_PAL(IRON_HANDS, gMonPalette_IronHands),
	SPECIES_PAL(IRON_JUGULIS, gMonPalette_IronJugulis),
	SPECIES_PAL(IRON_MOTH, gMonPalette_IronMoth),
	SPECIES_PAL(IRON_THORNS, gMonPalette_IronThorns),
	...
	SPECIES_PAL(POLTCHAGEIST, gMonPalette_Poltchageist),
    ...
    SPECIES_PAL(MOSSLO, gMonPalette_Mosslo),
    SPECIES_PAL(THERIMOSS, gMonPalette_Therimoss),
    SPECIES_PAL(MOSSIVE, gMonPalette_Mossive),
    SPECIES_PAL(GRIFLINT, gMonPalette_Griflint),
    SPECIES_PAL(GRIFLARE, gMonPalette_Griflare),
    SPECIES_PAL(GRYPHERNO, gMonPalette_Grypherno),
    SPECIES_PAL(WOOFIN, gMonPalette_Woofin),
    SPECIES_PAL(HOUNTIDE, gMonPalette_Hountide),
    SPECIES_PAL(SHARBARIC, gMonPalette_Sharbaric),
    SPECIES_PAL(BASSERINTH, gMonPalette_Basserinth),
    SPECIES_PAL(GAZEAR, gMonPalette_Gazear),
#endif
...
#if P_GEN_4_POKEMON == TRUE
    SPECIES_PAL(DIALGA_PRIMAL, gMonPalette_DialgaPrimal),
    SPECIES_PAL(PALKIA_PRIMAL, gMonPalette_PalkiaPrimal),
#endif
    ...
    SPECIES_PAL(PIKACHU_ALOLAN, gMonPalette_PikachuAlolan),
    SPECIES_PAL(EXEGGCUTE_ALOLAN, gMonPalette_ExeggcuteAlolan),
    SPECIES_PAL(CUBONE_ALOLAN, gMonPalette_CuboneAlolan),
...
#endif
    SPECIES_PAL(KOFFING_GALARIAN, gMonPalette_KoffingGalarian),
#if P_GEN_4_POKEMON == TRUE
    SPECIES_PAL(MIME_JR_GALARIAN, gMonPalette_MimeJrGalarian),
#endif
...
#endif
    SPECIES_PAL(CYNDAQUIL_HISUIAN, gMonPalette_CyndaquilHisuian),
    SPECIES_PAL(QUILAVA_HISUIAN, gMonPalette_QuilavaHisuian),
#if P_GEN_5_POKEMON == TRUE
    SPECIES_PAL(OSHAWOTT_HISUIAN, gMonPalette_OshawottHisuian),
    SPECIES_PAL(DEWOTT_HISUIAN, gMonPalette_DewottHisuian),
    SPECIES_PAL(PETILIL_HISUIAN, gMonPalette_PetililHisuian),
    SPECIES_PAL(RUFFLET_HISUIAN, gMonPalette_RuffletHisuian),
#endif
#if P_GEN_6_POKEMON == TRUE
    SPECIES_PAL(BERGMITE_HISUIAN, gMonPalette_BergmiteHisuian),
#endif
#if P_GEN_7_POKEMON == TRUE
    SPECIES_PAL(ROWLET_HISUIAN, gMonPalette_RowletHisuian),
    SPECIES_PAL(DARTRIX_HISUIAN, gMonPalette_DartrixHisuian),
#endif

    SPECIES_PAL(TAUROS_PALDEAN_COMBAT, gMonPalette_TaurosCombatPaldean),
	SPECIES_PAL(TAUROS_PALDEAN_BLAZE, gMonPalette_TaurosBlazePaldean),
	SPECIES_PAL(TAUROS_PALDEAN_AQUA, gMonPalette_TaurosAquaPaldean),
    ...
    SPECIES_PAL(SHELLOS_SOUTH_SEA, gMonPalette_ShellosSouthSea),
    SPECIES_PAL(SHELLOS_NORTH_SEA, gMonPalette_ShellosNorthSea),

    SPECIES_PAL(GASTRODON_EAST_SEA, gMonPalette_GastrodonEastSea),
    SPECIES_PAL(GASTRODON_SOUTH_SEA, gMonPalette_GastrodonSouthSea),
    SPECIES_PAL(GASTRODON_NORTH_SEA, gMonPalette_GastrodonNorthSea),
    ...
    SPECIES_PAL(ROTOM_DEX_1, gMonPalette_RotomDex1),
    SPECIES_PAL(ROTOM_DEX_2, gMonPalette_RotomDex2),
    SPECIES_PAL(ROTOM_DEX_3, gMonPalette_RotomDex3),
    SPECIES_PAL(ROTOM_DEX_4, gMonPalette_RotomDex4),
    SPECIES_PAL(ROTOM_DRON, gMonPalette_RotomDron),
    ...
    SPECIES_PAL(BASCULIN_YELLOW_STRIPED, gMonPalette_BasculinYellowStriped),
    ...
    SPECIES_PAL(SOLGALEO_BURST, gMonPalette_SolgaleoBurst),

    SPECIES_PAL(LUNALA_BURST, gMonPalette_LunalaBurst),
...
#endif
    #if P_GEN_9_POKEMON == TRUE
	SPECIES_PAL(OINKOLOGNE_FEMALE, gMonPalette_OinkologneFemale),
	SPECIES_PAL(MAUSHOLD_FAMILY, gMonPalette_MausholdFamily),
	...
	SPECIES_PAL(DUDUNSPARCE_THREE, gMonPalette_DudunsparceThree),
	SPECIES_PAL(GIMMIGHOUL_ROAMING, gMonPalette_GimmighoulRoaming),
	SPECIES_PAL(POLTCHAGEIST_MASTERPIECE, gMonPalette_PoltchageistMasterpiece),
	SPECIES_PAL(SINISTCHA_MASTERPIECE, gMonPalette_SinistchaMasterpiece),
	SPECIES_PAL(OGERPON_WELLSPRING, gMonPalette_OgerponWellspring),
	SPECIES_PAL(OGERPON_HEATHFLAME, gMonPalette_OgerponHeathflame),
...
#endif
    SPECIES_PAL(BULBASAUR_CLONE, gMonPalette_BulbasaurClone),
    SPECIES_PAL(IVYSAUR_CLONE, gMonPalette_IvysaurClone),
    SPECIES_PAL(VENUSAUR_CLONE, gMonPalette_VenusaurClone),
    SPECIES_PAL(CHARMANDER_CLONE, gMonPalette_CharmanderClone),
    SPECIES_PAL(CHARMELEON_CLONE, gMonPalette_CharmeleonClone),
    SPECIES_PAL(CHARIZARD_CLONE, gMonPalette_CharizardClone),
    SPECIES_PAL(SQUIRTLE_CLONE, gMonPalette_SquirtleClone),
    SPECIES_PAL(WARTORTLE_CLONE, gMonPalette_WartortleClone),
    SPECIES_PAL(BLASTOISE_CLONE, gMonPalette_BlastoiseClone),

    SPECIES_PAL(ONIX_CRYSTAL, gMonPalette_OnixCrystal),
    SPECIES_PAL(STEELIX_CRYSTAL, gMonPalette_SteelixCrystal),
    SPECIES_PAL(STEELIX_MEGA_CRYSTAL, gMonPalette_SteelixMegaCrystal),

    SPECIES_PAL(CATERPIE_PINK, gMonPalette_CaterpiePink),
    SPECIES_PAL(METAPOD_PINK, gMonPalette_MetapodPink),
    SPECIES_PAL(BUTTERFREE_PINK, gMonPalette_ButterfreePink),

    SPECIES_PAL(LUGIA_DARK, gMonPalette_LugiaDark),
    SPECIES_PAL(HO_OH_DARK, gMonPalette_HoOhDark),
