...
const u8 gMossloPokedexText[] = _(
    "A new specie discovered.");

const u8 gTherimossPokedexText[] = _(
    "A new specie discovered.");

const u8 gMossivePokedexText[] = _(
    "A new specie discovered.");

const u8 gGriflintPokedexText[] = _(
    "A new specie discovered.");

const u8 gGriflarePokedexText[] = _(
    "A new specie discovered.");

const u8 gGryphernoPokedexText[] = _(
    "A new specie discovered.");

const u8 gWoofinPokedexText[] = _(
    "A new specie discovered.");

const u8 gHountidePokedexText[] = _(
    "A new specie discovered.");

const u8 gSharbaricPokedexText[] = _(
    "A new specie discovered.");

const u8 gBasserinthPokedexText[] = _(
    "A new specie discovered.");

const u8 gGazearPokedexText[] = _(
    "A new specie discovered.");
#endif
