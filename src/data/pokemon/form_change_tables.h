...
static const struct FormChange sPalafinFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE, SPECIES_PALAFIN, ITEM_REVEAL_GLASS},
    {FORM_CHANGE_ITEM_USE, SPECIES_PALAFIN_HERO, ITEM_REVEAL_GLASS},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sTatsugiriFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_TATSUGIRI_DROOPY, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50},
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_TATSUGIRI_STRETCHY, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50},
    {FORM_CHANGE_BATTLE_SWITCH,     SPECIES_TATSUGIRI},
    {FORM_CHANGE_FAINT,             SPECIES_TATSUGIRI},
    {FORM_CHANGE_END_BATTLE,        SPECIES_TATSUGIRI},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sGimmighoulFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE, SPECIES_GIMMIGHOUL, ITEM_REVEAL_GLASS},
    {FORM_CHANGE_ITEM_USE, SPECIES_GIMMIGHOUL_ROAMING, ITEM_REVEAL_GLASS},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sOgerponFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE, SPECIES_OGERPON, ITEM_REVEAL_GLASS},
    {FORM_CHANGE_ITEM_USE, SPECIES_OGERPON_WELLSPRING, ITEM_REVEAL_GLASS},
    {FORM_CHANGE_ITEM_USE, SPECIES_OGERPON_HEATHFLAME, ITEM_RARE_CANDY},
    {FORM_CHANGE_ITEM_USE, SPECIES_OGERPON_CORNERSTONE, ITEM_POTION},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sTerapagosFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE, SPECIES_TERAPAGOS, ITEM_REVEAL_GLASS},
    {FORM_CHANGE_ITEM_USE, SPECIES_TERAPAGOS_TERASTAL, ITEM_REVEAL_GLASS},
    {FORM_CHANGE_TERMINATOR},
};
#endif*/
