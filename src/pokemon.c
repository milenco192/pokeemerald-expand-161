...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(MOSSLO),
    SPECIES_TO_NATIONAL(THERIMOSS),
    SPECIES_TO_NATIONAL(MOSSIVE),
    SPECIES_TO_NATIONAL(GRIFLINT),
    SPECIES_TO_NATIONAL(GRIFLARE),
    SPECIES_TO_NATIONAL(GRYPHERNO),
    SPECIES_TO_NATIONAL(WOOFIN),
    SPECIES_TO_NATIONAL(HOUNTIDE),
    SPECIES_TO_NATIONAL(SHARBARIC),
    SPECIES_TO_NATIONAL(BASSERINTH),
    SPECIES_TO_NATIONAL(GAZEAR),
#endif
    ...
    [SPECIES_PIKACHU_ALOLAN - 1] = NATIONAL_DEX_PIKACHU,
    [SPECIES_EXEGGCUTE_ALOLAN - 1] = NATIONAL_DEX_EXEGGCUTE,
    [SPECIES_CUBONE_ALOLAN - 1] = NATIONAL_DEX_CUBONE,
    // Galarian Forms
    ...
    [SPECIES_KOFFING_GALARIAN - 1] = NATIONAL_DEX_KOFFING,
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_MIME_JR_GALARIAN - 1] = NATIONAL_DEX_MIME_JR,
#endif
#if P_GEN_5_POKEMON == TRUE
...
#endif
    [SPECIES_CYNDAQUIL_HISUIAN - 1] = NATIONAL_DEX_CYNDAQUIL,
    [SPECIES_QUILAVA_HISUIAN - 1] = NATIONAL_DEX_QUILAVA,
#if P_GEN_5_POKEMON == TRUE
    [SPECIES_OSHAWOTT_HISUIAN - 1] = NATIONAL_DEX_OSHAWOTT,
    [SPECIES_DEWOTT_HISUIAN - 1] = NATIONAL_DEX_DEWOTT,
    [SPECIES_PETILIL_HISUIAN - 1] = NATIONAL_DEX_PETILIL,
    [SPECIES_RUFFLET_HISUIAN - 1] = NATIONAL_DEX_RUFFLET,
#endif
#if P_GEN_6_POKEMON == TRUE
    [SPECIES_BERGMITE_HISUIAN - 1] = NATIONAL_DEX_BERGMITE,
#endif
#if P_GEN_7_POKEMON == TRUE
    [SPECIES_ROWLET_HISUIAN - 1] = NATIONAL_DEX_ROWLET,
    [SPECIES_DARTRIX_HISUIAN - 1] = NATIONAL_DEX_DARTRIX,
#endif
//Paldean Forms
    [SPECIES_TAUROS_PALDEAN_COMBAT - 1] = NATIONAL_DEX_TAUROS,
    [SPECIES_TAUROS_PALDEAN_BLAZE - 1] = NATIONAL_DEX_TAUROS,
    [SPECIES_TAUROS_PALDEAN_AQUA - 1] = NATIONAL_DEX_TAUROS,
    ...
    [SPECIES_SHELLOS_SOUTH_SEA - 1] = NATIONAL_DEX_SHELLOS,
    [SPECIES_SHELLOS_NORTH_SEA - 1] = NATIONAL_DEX_SHELLOS,
    // Gastrodon
    [SPECIES_GASTRODON_EAST_SEA - 1] = NATIONAL_DEX_GASTRODON,
    [SPECIES_GASTRODON_SOUTH_SEA - 1] = NATIONAL_DEX_GASTRODON,
    [SPECIES_GASTRODON_NORTH_SEA - 1] = NATIONAL_DEX_GASTRODON,
    // Rotom
    ...
    [SPECIES_ROTOM_DEX_1 - 1] = NATIONAL_DEX_ROTOM,
    [SPECIES_ROTOM_DEX_2 - 1] = NATIONAL_DEX_ROTOM,
    [SPECIES_ROTOM_DEX_3 - 1] = NATIONAL_DEX_ROTOM,
    [SPECIES_ROTOM_DEX_4 - 1] = NATIONAL_DEX_ROTOM,
    [SPECIES_ROTOM_DRON - 1] = NATIONAL_DEX_ROTOM,
    // Origin Forme
    ...
    [SPECIES_BASCULIN_YELLOW_STRIPED - 1] = NATIONAL_DEX_BASCULIN,
    // Darmanitan
    ...
    // Solgaleo
    [SPECIES_SOLGALEO_BURST - 1] = NATIONAL_DEX_SOLGALEO,
    // Lunala
    [SPECIES_LUNALA_BURST - 1] = NATIONAL_DEX_LUNALA,
    // Necrozma
    ...
    // Maushold
    [SPECIES_MAUSHOLD_FAMILY - 1] = NATIONAL_DEX_MAUSHOLD,
    // Squawkabilly
    [SPECIES_SQUAWKABILLY_BLUE - 1] = NATIONAL_DEX_SQUAWKABILLY,
    [SPECIES_SQUAWKABILLY_YELLOW - 1] = NATIONAL_DEX_SQUAWKABILLY,
    [SPECIES_SQUAWKABILLY_WHITE - 1] = NATIONAL_DEX_SQUAWKABILLY,
    // Palafin
    ...
    // Dudunsparce
    [SPECIES_DUDUNSPARCE_THREE - 1] = NATIONAL_DEX_TATSUGIRI,
    // Gimmighoul
    [SPECIES_GIMMIGHOUL_ROAMING - 1] = NATIONAL_DEX_GIMMIGHOUL,
    // Poltchageist
    [SPECIES_POLTCHAGEIST_MASTERPIECE - 1] = NATIONAL_DEX_POLTCHAGEIST,
    // Sinistcha
    [SPECIES_SINISTCHA_MASTERPIECE - 1] = NATIONAL_DEX_SINISTCHA,
    // Ogerpon
    [SPECIES_OGERPON_WELLSPRING - 1] = NATIONAL_DEX_OGERPON,
    [SPECIES_OGERPON_HEATHFLAME - 1] = NATIONAL_DEX_OGERPON,
    [SPECIES_OGERPON_CORNERSTONE - 1] = NATIONAL_DEX_OGERPON,
    // Terapagos
    [SPECIES_TERAPAGOS_TERASTAL - 1] = NATIONAL_DEX_TERAPAGOS,
#endif
    // Clones
    [SPECIES_BULBASAUR_CLONE - 1] = NATIONAL_DEX_BULBASAUR,
    [SPECIES_IVYSAUR_CLONE - 1] = NATIONAL_DEX_IVYSAUR,
    [SPECIES_VENUSAUR_CLONE - 1] = NATIONAL_DEX_VENUSAUR,
    [SPECIES_CHARMANDER_CLONE - 1] = NATIONAL_DEX_CHARMANDER,
    [SPECIES_CHARMELEON_CLONE - 1] = NATIONAL_DEX_CHARMELEON,
    [SPECIES_CHARIZARD_CLONE - 1] = NATIONAL_DEX_CHARIZARD,
    [SPECIES_SQUIRTLE_CLONE - 1] = NATIONAL_DEX_SQUIRTLE,
    [SPECIES_WARTORTLE_CLONE - 1] = NATIONAL_DEX_WARTORTLE,
    [SPECIES_BLASTOISE_CLONE - 1] = NATIONAL_DEX_BLASTOISE,
    // Crystal
    [SPECIES_ONIX_CRYSTAL - 1] = NATIONAL_DEX_ONIX,
    [SPECIES_STEELIX_CRYSTAL - 1] = NATIONAL_DEX_STEELIX,
    [SPECIES_STEELIX_MEGA_CRYSTAL - 1] = NATIONAL_DEX_STEELIX,
    // Pink
    [SPECIES_CATERPIE_PINK - 1] = NATIONAL_DEX_CATERPIE,
    [SPECIES_METAPOD_PINK - 1] = NATIONAL_DEX_METAPOD,
    [SPECIES_BUTTERFREE_PINK - 1] = NATIONAL_DEX_BUTTERFREE,
    // Dark
    [SPECIES_LUGIA_DARK - 1] = NATIONAL_DEX_LUGIA,
    [SPECIES_HO_OH_DARK - 1] = NATIONAL_DEX_HO_OH,
};
...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_MOSSLO - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_THERIMOSS - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MOSSIVE - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GRIFLINT - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GRIFLARE - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GRYPHERNO - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_WOOFIN - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_HOUNTIDE - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SHARBARIC - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BASSERINTH - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GAZEAR - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
