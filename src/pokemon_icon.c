...
const u8 *const gMonIconTable[NUM_SPECIES + 1] =
{
    ...
    [SPECIES_POLTCHAGEIST] = gMonIcon_Poltchageist,
    ...
    [SPECIES_MOSSLO] = gMonIcon_Mosslo,
    [SPECIES_THERIMOSS] = gMonIcon_Therimoss,
    [SPECIES_MOSSIVE] = gMonIcon_Mossive,
    [SPECIES_GRIFLINT] = gMonIcon_Griflint,
    [SPECIES_GRIFLARE] = gMonIcon_Griflare,
    [SPECIES_GRYPHERNO] = gMonIcon_Grypherno,
    [SPECIES_WOOFIN] = gMonIcon_Woofin,
    [SPECIES_HOUNTIDE] = gMonIcon_Hountide,
    [SPECIES_SHARBARIC] = gMonIcon_Sharbaric,
    [SPECIES_BASSERINTH] = gMonIcon_Basserinth,
    [SPECIES_GAZEAR] = gMonIcon_Gazear,
#endif
...
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_DIALGA_PRIMAL] = gMonIcon_DialgaPrimal,
    [SPECIES_PALKIA_PRIMAL] = gMonIcon_PalkiaPrimal,
#endif
    ...
    [SPECIES_PIKACHU_ALOLAN] = gMonIcon_PikachuAlolan,
    [SPECIES_EXEGGCUTE_ALOLAN] = gMonIcon_ExeggcuteAlolan,
    [SPECIES_CUBONE_ALOLAN] = gMonIcon_CuboneAlolan,
...
#endif
    [SPECIES_KOFFING_GALARIAN] = gMonIcon_KoffingGalarian,
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_MIME_JR_GALARIAN] = gMonIcon_MimeJrGalarian,
#endif
...
#endif
    [SPECIES_CYNDAQUIL_HISUIAN] = gMonIcon_CyndaquilHisuian,
    [SPECIES_QUILAVA_HISUIAN] = gMonIcon_QuilavaHisuian,
#if P_GEN_5_POKEMON == TRUE
    [SPECIES_OSHAWOTT_HISUIAN] = gMonIcon_OshawottHisuian,
    [SPECIES_DEWOTT_HISUIAN] = gMonIcon_DewottHisuian,
    [SPECIES_PETILIL_HISUIAN] = gMonIcon_PetililHisuian,
    [SPECIES_RUFFLET_HISUIAN] = gMonIcon_RuffletHisuian,
#endif
#if P_GEN_6_POKEMON == TRUE
    [SPECIES_BERGMITE_HISUIAN] = gMonIcon_BergmiteHisuian,
#endif
#if P_GEN_7_POKEMON == TRUE
    [SPECIES_ROWLET_HISUIAN] = gMonIcon_RowletHisuian,
    [SPECIES_DARTRIX_HISUIAN] = gMonIcon_DartrixHisuian,
#endif
    [SPECIES_TAUROS_PALDEAN_COMBAT] = gMonIcon_TaurosCombatPaldean,
    [SPECIES_TAUROS_PALDEAN_BLAZE] = gMonIcon_TaurosBlazePaldean,
    [SPECIES_TAUROS_PALDEAN_AQUA] = gMonIcon_TaurosAquaPaldean,
    ...
    [SPECIES_SHELLOS_SOUTH_SEA] = gMonIcon_ShellosSouthSea,
    [SPECIES_SHELLOS_NORTH_SEA] = gMonIcon_ShellosNorthSea,
    [SPECIES_GASTRODON_EAST_SEA] = gMonIcon_GastrodonEastSea,
    [SPECIES_GASTRODON_SOUTH_SEA] = gMonIcon_GastrodonSouthSea,
    [SPECIES_GASTRODON_NORTH_SEA] = gMonIcon_GastrodonNorthSea,
    ...
    [SPECIES_ROTOM_DEX_1] = gMonIcon_RotomDex1,
    [SPECIES_ROTOM_DEX_2] = gMonIcon_RotomDex2,
    [SPECIES_ROTOM_DEX_3] = gMonIcon_RotomDex3,
    [SPECIES_ROTOM_DEX_4] = gMonIcon_RotomDex4,
    [SPECIES_ROTOM_DRON] = gMonIcon_RotomDron,
    ...
    [SPECIES_BASCULIN_YELLOW_STRIPED] = gMonIcon_BasculinYellowStriped,
    ...
    [SPECIES_SOLGALEO_BURST] = gMonIcon_SolgaleoBurst,
    [SPECIES_LUNALA_BURST] = gMonIcon_LunalaBurst,
    ...
    [SPECIES_MAUSHOLD_FAMILY] = gMonIcon_MausholdFamily,
    [SPECIES_SQUAWKABILLY_BLUE] = gMonIcon_SquawkabillyBlue,
    [SPECIES_SQUAWKABILLY_YELLOW] = gMonIcon_SquawkabillyYellow,
    [SPECIES_SQUAWKABILLY_WHITE] = gMonIcon_SquawkabillyWhite,
    ...
    [SPECIES_DUDUNSPARCE_THREE] = gMonIcon_DudunsparceThree,
    [SPECIES_GIMMIGHOUL_ROAMING] = gMonIcon_GimmighoulRoaming,
    [SPECIES_POLTCHAGEIST_MASTERPIECE] = gMonIcon_PoltchageistMasterpiece,
    [SPECIES_SINISTCHA_MASTERPIECE] = gMonIcon_Sinistcha,
    [SPECIES_OGERPON_WELLSPRING] = gMonIcon_OgerponWellspring,
    [SPECIES_OGERPON_HEATHFLAME] = gMonIcon_OgerponHeathflame,
    [SPECIES_OGERPON_CORNERSTONE] = gMonIcon_OgerponCornerstone,
    [SPECIES_TERAPAGOS_TERASTAL] = gMonIcon_TerapagosTerastal,
#endif
    [SPECIES_BULBASAUR_CLONE] = gMonIcon_BulbasaurClone,
    [SPECIES_IVYSAUR_CLONE] = gMonIcon_IvysaurClone,
    [SPECIES_VENUSAUR_CLONE] = gMonIcon_VenusaurClone,
    [SPECIES_CHARMANDER_CLONE] = gMonIcon_CharmanderClone,
    [SPECIES_CHARMELEON_CLONE] = gMonIcon_CharmeleonClone,
    [SPECIES_CHARIZARD_CLONE] = gMonIcon_CharizardClone,
    [SPECIES_SQUIRTLE_CLONE] = gMonIcon_SquirtleClone,
    [SPECIES_WARTORTLE_CLONE] = gMonIcon_WartortleClone,
    [SPECIES_BLASTOISE_CLONE] = gMonIcon_BlastoiseClone,
    [SPECIES_ONIX_CRYSTAL] = gMonIcon_OnixCrystal,
    [SPECIES_STEELIX_CRYSTAL] = gMonIcon_SteelixCrystal,
    [SPECIES_STEELIX_MEGA_CRYSTAL] = gMonIcon_SteelixMegaCrystal,
    [SPECIES_CATERPIE_PINK] = gMonIcon_CaterpiePink,
    [SPECIES_METAPOD_PINK] = gMonIcon_MetapodPink,
    [SPECIES_BUTTERFREE_PINK] = gMonIcon_ButterfreePink,
    [SPECIES_LUGIA_DARK] = gMonIcon_LugiaDark,
    [SPECIES_HO_OH_DARK] = gMonIcon_HoOhDark,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_PIKACHU_ALOLAN] = 0,
    [SPECIES_EXEGGCUTE_ALOLAN] = 0,
    [SPECIES_CUBONE_ALOLAN] = 0,
    ...
    [SPECIES_KOFFING_GALARIAN] = 0,
    [SPECIES_MIME_JR_GALARIAN] = 0,
    ...
    [SPECIES_CYNDAQUIL_HISUIAN] = 0,
    [SPECIES_QUILAVA_HISUIAN] = 0,
    [SPECIES_OSHAWOTT_HISUIAN] = 0,
    [SPECIES_DEWOTT_HISUIAN] = 0,
    [SPECIES_PETILIL_HISUIAN] = 0,
    [SPECIES_RUFFLET_HISUIAN] = 0,
    [SPECIES_BERGMITE_HISUIAN] = 0,
    [SPECIES_ROWLET_HISUIAN] = 0,
    [SPECIES_DARTRIX_HISUIAN] = 0,
    [SPECIES_TAUROS_PALDEAN_COMBAT] = 0,
    [SPECIES_TAUROS_PALDEAN_BLAZE] = 0,
    [SPECIES_TAUROS_PALDEAN_AQUA] = 0,
    ...
    [SPECIES_SHELLOS_SOUTH_SEA] = 0,
    [SPECIES_SHELLOS_NORTH_SEA] = 0,
    [SPECIES_GASTRODON_EAST_SEA] = 0,
    [SPECIES_GASTRODON_SOUTH_SEA] = 0,
    [SPECIES_GASTRODON_NORTH_SEA] = 0,
    [SPECIES_ROTOM_HEAT] = 0,
    [SPECIES_ROTOM_WASH] = 0,
    [SPECIES_ROTOM_FROST] = 5,
    [SPECIES_ROTOM_FAN] = 0,
    [SPECIES_ROTOM_MOW] = 0,
    [SPECIES_ROTOM_DEX_1] = 0,
    [SPECIES_ROTOM_DEX_2] = 0,
    [SPECIES_ROTOM_DEX_3] = 0,
    [SPECIES_ROTOM_DEX_4] = 0,
    [SPECIES_ROTOM_DRON] = 0,
    ...
    [SPECIES_BASCULIN_YELLOW_STRIPED] = 0,
    ...
    [SPECIES_SOLGALEO_BURST] = 0,
    [SPECIES_LUNALA_BURST] = 0,
    ...
    [SPECIES_OGERPON_HEATHFLAME] = 0,
    [SPECIES_OGERPON_CORNERSTONE] = 0,
    [SPECIES_TERAPAGOS_TERASTAL] = 0,
#endif
    [SPECIES_BULBASAUR_CLONE] = 0,
    [SPECIES_IVYSAUR_CLONE] = 0,
    [SPECIES_VENUSAUR_CLONE] = 0,
    [SPECIES_CHARMANDER_CLONE] = 0,
    [SPECIES_CHARMELEON_CLONE] = 0,
    [SPECIES_CHARIZARD_CLONE] = 0,
    [SPECIES_SQUIRTLE_CLONE] = 0,
    [SPECIES_WARTORTLE_CLONE] = 0,
    [SPECIES_BLASTOISE_CLONE] = 0,
    [SPECIES_ONIX_CRYSTAL] = 0,
    [SPECIES_STEELIX_CRYSTAL] = 0,
    [SPECIES_STEELIX_MEGA_CRYSTAL] = 0,
    [SPECIES_CATERPIE_PINK] = 0,
    [SPECIES_METAPOD_PINK] = 0,
    [SPECIES_BUTTERFREE_PINK] = 0,
    [SPECIES_LUGIA_DARK] = 0,
    [SPECIES_HO_OH_DARK] = 0,
    [SPECIES_EGG] = 1,
};
